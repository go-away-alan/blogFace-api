...
# Team Project - blogFace API

This is the Express API for our Team Project to be used in conjunction with blogFace Client. It contains the controllers, models, and routes for the resources associated with our app.
...
Below is a catalog of routes (paths and methods) that the API expects for each of our resources.
